...
<div id="randomWindow" class="random-window d-flex justify-content-center align-items-center">
    <div id="zoomIn" class="menu-window base-bg d-flex flex-column">
        ...
        <div class="d-flex justify-content-around align-items-center vh-100 icon-window">
            <div class="col-auto text-center" hx-get="{% url 'create-asset' %}" hx-push-url="true" hx-target="#randomWindow">               
                <a href="{{ route('createasset') }}" hx-push-url="true" hx-target="#randomWindow" hx-swap="outerHTML transition:true">
                <i class="icon fa-thin fa-cart-flatbed-boxes"></i>
                    <p>Create Assets</p>
                </a>
               
            </div>
            <div class="col-auto text-center" hx-get="{% url 'assets-list' %}" hx-push-url="true" hx-target="#randomWindow">               
                <a href="{{ route('assetlist') }}" hx-push-url="true" hx-target="#randomWindow" hx-swap="outerHTML transition:true">
