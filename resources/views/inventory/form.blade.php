...
<div id="randomWindow" class="random-window d-flex justify-content-center align-items-center">
	...
	<div id="zoomIn" class="content-window base-bg">
		...
		<h4 class="px-4 mt-2">Create Asset</h4>

		<form hx-post="{% url 'create-asset' %}" class="ml-2">
			<div class="d-flex flex-lg-row flex-column justify-content-around mb-2">
				<div class="col px-4">
					...
					<select name="device_select" id="device_select" class="form-control form-select">
				...
				<div class="col px-4">
					...
					<select name="site_zones" id="site_zones" class="form-control form-select">
						<option value="">Select Zones</option>
						<option value="{{ 'site.id' }}">{{ 'site.identity' }}</option>
					</select>
				</div>
			</div>
			<div class="d-flex flex-lg-row flex-column justify-content-around mb-2">
			...
			<div class="d-flex flex-lg-row flex-column justify-content-around mb-2">
				<div class="col px-4">
					...
					<input type="text" id="ip_address" name="ip_address" class="form-control" placeholder="Enter Ip Address" required>
				</div>
				<div class="col px-4">
					<label for="host_name" class="form-label mb-0">Access Host Name</label>
					<input type="text" id="host_name" name="host_name" class="form-control" placeholder="Enter Access Host Name" required>
				</div>
			</div>
			<div class="d-flex flex-lg-row flex-column justify-content-around mb-2">
				<div class="col px-4">
