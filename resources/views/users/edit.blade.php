...
<div id="randomWindow" class="random-window d-flex justify-content-center align-items-center">
	...
	<div id="zoomIn" class="content-window base-bg">
		...
		<h4 class="px-4 mt-2">Edit User</h4>
		...
		<form hx-post="{% url 'create-user' %}" class="ml-2">
			...
			<div class="d-flex flex-lg-row flex-column justify-content-around mb-2">
				<div class="col px-4">
					...
					<input type="text" id="username" name="username" class="form-control" hx-post="{% url 'username_check' %}" hx-trigger="keyup delay:1s" hx-target="#username-error" hx-swap="outerHTML" value="{{ 'user.username' }}" required>
			...
			<div class="d-flex flex-lg-row flex-column justify-content-around mb-2">
				<div class="col px-4">
					...
					<input type="number" id="user_phone" name="user_phone" class="form-control" value="{{ 'user.contact_no' }}" required>
				</div>
				<div class="col px-4">
			...
			<div class="d-flex flex-lg-row flex-column justify-content-around mb-2">
				<div class="col px-4">
					...
					<input type="text" id="allowed_device" name="allowed_device" class="form-control" value="{{ 'user.allowed_devices' }}" required>
				</div>
