    ...
    <div id="dashboardIcon" class="col-md-12 window-icon">
        <div class="icon-section">
            <div class="col mt-0 d-flex justify-content-start flex-wrap">
               ...
               <div class="col-lg-2 col-6 col-sm-4 text-center">
                    <a hx-get="{% url 'services-menu' %}" hx-push-url="true" hx-target="#randomWindow" hx-swap="outerHTML transition:true">
                    <i class="icon fa-thin fa-screwdriver-wrench"></i>
                    </a>
                    <p>Services</p>
                </div>
               <div class="col-lg-2 col-6 col-sm-4 text-center">
                    <a hx-get="{% url 'managers-menu' %}" hx-push-url="true" hx-target="#randomWindow" hx-swap="outerHTML transition:true">
                    <i class="icon fa-thin fa-user-tie"></i>
                    </a>
                    <p>Managers</p>
                </div>
               <div class="col-lg-2 col-6 col-sm-4 text-center">
                    <a hx-get="{% url 'nas-menu' %}" hx-push-url="true" hx-target="#randomWindow" hx-swap="outerHTML transition:true">
               ...
               <div class="col-lg-2 col-6 col-sm-4 text-center">
                    <a hx-get="{% url 'routers-menu' %}" hx-push-url="true" hx-target="#randomWindow" hx-swap="outerHTML transition:true">
               ...
               <div class="col-lg-2 col-6 col-sm-4 text-center">
                    <a hx-get="{% url 'reports-menu' %}" hx-push-url="true" hx-target="#randomWindow" hx-swap="outerHTML transition:true">
                ...
                <!-- Inventory menu end -->
               <div class="col-lg-2 col-6 col-sm-4 text-center">
                    <a hx-get="{% url 'expense-menu' %}" hx-push-url="true" hx-target="#randomWindow" hx-swap="outerHTML transition:true">
                    <i class="icon fa-thin fa-hand-holding-circle-dollar"></i>
                    </a>
                    <p>Expense</p>
                </div>
               <div class="col-lg-2 col-6 col-sm-4 text-center">
                    <a hx-get="{% url 'inventory-menu' %}" hx-push-url="true" hx-target="#randomWindow" hx-swap="outerHTML transition:true">
                ...
                <!-- Logs menu start -->
               <div class="col-lg-2 col-6 col-sm-4 text-center">
                    <a hx-get="{% url 'logs-menu' %}" hx-push-url="true" hx-target="#randomWindow" hx-swap="outerHTML transition:true">
